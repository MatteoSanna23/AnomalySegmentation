...
class MaskClassificationSemantic(LightningModule):
    def __init__(
        self,
        network: nn.Module,
        criterion: nn.Module,  # <--- MODIFICA: Riceve la loss già configurata dallo YAML
        ...
        # Utilizziamo il criterio passato come argomento (es. ArcFace configurata nello YAML)
